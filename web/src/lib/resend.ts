    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111827">
        ...
        <div style="padding:32px;background:#ffffff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
          ...
          <p style="color:#374151;line-height:1.6">
            Ingresa a tu panel para ver tus reservas y gestionar tu servicio.
          </p>
    ...
    html: `
      <div style="font-family:sans-serif;max-width:560px;margin:0 auto;color:#111827">
        ...
        <div style="padding:32px;background:#ffffff;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px">
          ...
          <p style="color:#374151;line-height:1.6">
            Actualiza tu información y vuelve a enviarla para revisión. Si tienes dudas, contáctanos.
          </p>
